...
node {
    ...
    stage('upload package to instance 2') {
        ...
        sh "scp -i 'gateway.pem' ../IpponInsurance_gateway/target/gateway-0.0.1-SNAPSHOT.war ec2-user@ec2-35-174-136-82.compute-1.amazonaws.com:/home/ec2-user/app/gateway/"
    ...
    stage('upload package to instance 1') {
        ...
        sh "scp -i 'gateway.pem' ../IpponInsurance_gateway/target/gateway-0.0.1-SNAPSHOT.war ec2-user@ec2-54-172-53-119.compute-1.amazonaws.com:/home/ec2-user/app/gateway/"
